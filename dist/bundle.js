...
var _XLabels = __webpack_require__(13);
...
function HeatMap(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    null,
    xLabelsLocation === 'top' && _react2.default.createElement(_XLabels2.default, { labels: xLabels, width: xLabelWidth, labelsVisibility: xLabelsVisibility }),
    _react2.default.createElement(_DataGrid2.default, { xLabels: xLabels, yLabels: yLabels, data: data, background: background, height: height, xLabelWidth: xLabelWidth, yLabelTextAlign: yLabelTextAlign, unit: unit, xLabelsLocation: xLabelsLocation }),
    xLabelsLocation === 'bottom' && _react2.default.createElement(_XLabels2.default, { labels: xLabels, width: xLabelWidth, labelsVisibility: xLabelsVisibility })
  );
}
...
function XLabels(_ref) {
  ...
  return _react2.default.createElement(
    ...
    labels.map(function (x, i) {
      return _react2.default.createElement(
        'div',
        { key: x, style: { flex: 1, textAlign: 'center', visibility: labelsVisibility && labelsVisibility[i] === false ? 'hidden' : 'visible' } },
        x
      );
    })
  );
...
var _HeatMap = __webpack_require__(11);
